...
# 5.3 Explicación del Código Web

En esta sección explicaremos todo el código de la api encargada de backend y la interfaz que gestiona el front end

## 5.3.1 Frontend


La aplicación web está diseñada para que su uso sea muy intuitivo, facilitando su uso al cliente de nuestro restaurante. Para empezar, cada subsistema y sus funcionalidades están repartidas en distintas páginas, a las que se puede acceder mediante botones desde la página principal, como podemos ver aquí: 

![Captura desde 2024-01-21 23-27-00](https://github.com/Arzenin/Sistema-Mc-And-Cheese/assets/79646195/a995aef4-fbe2-413e-a22f-62020ec66a39)

Además, hay un botón para reiniciar la base de datos en caso de que queramos “jugar” con ella. 

Ahora veremos cada subsistema:

Menú: primero tenemos una tabla con las diferentes recetas que existen actualmente en nuestro menú. A la derecha de cada fila de la tabla tenemos 2 botones: un ojo, que sirve para ver los ingredientes y alérgenos de la receta y una papelera para eliminar la receta.  Abajo de la tabla podemos encontrar un botón +, para crear nuevas recetas con los ingredientes ya existentes, y 2 botones: alérgenos e ingredientes, donde podemos encontrar de forma similar a esta página los diferentes alérgenos e ingredientes del menú, pudiendo borrarlos o crear nuevos:

![Captura desde 2024-01-21 23-27-37](https://github.com/Arzenin/Sistema-Mc-And-Cheese/assets/79646195/49cea374-624e-4dac-9a24-37096321936b)

Clientes: igual que en menú, tenemos una tabla con la información de los clientes, pudiendo editar, eliminar y crear nuevos clientes. Además, encontramos una sección alérgenos, donde podemos ver, añadir y quitar alérgenos a los clientes:

![Captura desde 2024-01-21 23-28-31](https://github.com/Arzenin/Sistema-Mc-And-Cheese/assets/79646195/e5923876-3792-4f0e-b7b2-9653acd311ad)


Pedidos: en este subsistema tenemos una tabla con todos los pedidos (activos e inactivos), pudiendo crear un pedido nuevo con el botón +. Además, podemos acceder a otras 2 tablas donde ver los pedidos activos y los inactivos. En la tabla de pedidos activos es donde podemos finalizar un pedido pulsando en el tick de la derecha de cada pedido: 

![Captura desde 2024-01-21 23-29-03](https://github.com/Arzenin/Sistema-Mc-And-Cheese/assets/79646195/c9ec8a68-ef0c-4644-933f-61ff3d6b5fd9)

Reservas: aquí podemos encontrar una tabla con todas las reservas junto con su información. El botón mesas sirve para crear un nueva nueva mesa y un nuevo ID de reserva, que más tarde utilizaremos para crear reservas usando el botón + de nuestra tabla. Además, podemos consultar la información completa de la reserva (botón de la libreta), modificar el número de comensales (siempre disminuyendolo, usando el botón del lápiz) o eliminarla (botón de la papelera):

![Captura desde 2024-01-21 23-29-55](https://github.com/Arzenin/Sistema-Mc-And-Cheese/assets/79646195/97a24128-a218-4bb8-8ccf-6d00dfc61bf9)


Trabajadores: el último subsistema se encarga de gestionar los trabajadores de nuestro restaurante, por lo que en él podemos encontrar una tabla con toda la información de los trabajadores, junto con botones para crear, editar o eliminar trabajadores: 

![Captura desde 2024-01-21 23-30-26](https://github.com/Arzenin/Sistema-Mc-And-Cheese/assets/79646195/3ca85741-7e85-45fd-b619-175dbb1f8e64)

# 5.3.2 Backend

Para finalizar con lo que explicaciones respecta se va a explicar de forma agrupada el archivo __api.js__ ya que muchas de las funciones guardan similitudes entre sí. Únicamente se explicará una función.


En nuestro back-end tenemos diferentes “tipos” de llamadas, las cuales nos servirán para poder gestionar de manera sencilla los datos de nuestra aplicación. Algunos tipos de funciones son:


- __Funciones de consulta:__ estas funciones nos devuelven de la base de datos los datos de una o más tablas que cumplan ciertos requisitos. Tenemos las que nos devuelven una tabla entera (que solemos usar para rellenar las tablas que muestran la información de clientes, trabajadores, pedidos, menús…). También tenemos las funciones de consulta de un objeto concreto, donde pasándole el id en la cabecera de la llamada, nos devolverá la información de ese objeto en concreto.
...
```
- __Funciones de creación:__ nos permiten insertar nuevos datos en las tablas, lo cual es fundamental en el contexto de nuestra aplicación, pues un restaurante tiene trabajadores, clientes, menús, pedidos, etc cambiantes. 
...
```
- __Funciones de edición:__ permiten editar algunas características de los datos que ya se encuentran en las tablas, permitiéndonos cambiar los datos sin la necesidad de eliminar y crear unos nuevos. Esto nos aporta una gran flexibilidad y resolución de errores de manera sencilla. 
...
```
- __Funciones de borrado:__ nos permiten eliminar datos de nuestra base de datos en caso de que no queramos guardarlos más. Al igual que con la edición de datos, nos permite corregir datos que hayan sido insertados con errores o a eliminar datos redundantes que ya no nos vayan a hacer falta. 
...
# 5.3.2.1 Código del Backend

En caso de no disponer de conexión se ha decidido adjuntar a continuación el fichero correspendiente al backend de nuestro cógigo, esperamos que lo disfruten :) patata
